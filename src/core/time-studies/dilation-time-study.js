    ...
    if (this.id === 6) {
      ...
      if (!PlayerProgress.realityUnlocked()) {
        Modal.message.show(`Reality Machine gain for your first Reality is reduced above ${format("1e6000")} Eternity
          Points and reduced even further above ${format("1e9000")} Eternity Points. This is due to balance changes made
          in my mod, making things much more powerful. Even though you obviously won't push much further than that,
          Reality Machine gain is capped at ${format("1e12000")} Eternity Points.`, {}, 3);
