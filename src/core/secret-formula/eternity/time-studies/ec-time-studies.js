...
export const ecTimeStudies = [
  {
    ...
    secondary: {
      ...
      required: completions => new Decimal(20000 + Math.min(completions, Enslaved.isRunning ? 999 : 4) * 2500),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => 1000 + Math.min(completions, 4) * 150,
      formatValue: formatInt
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => new Decimal(15300 + Math.min(completions, 4) * 1250),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => new Decimal(5e7 + Math.min(completions, 4) * 1.125e7),
      formatValue: value => formatInt(Math.floor(value.toNumber()))
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => 150 + Math.min(completions, 4) * 14,
      formatValue: formatInt
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => 30 + Math.min(completions, 4) * 5,
      formatValue: formatInt
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E200000.pow(Math.min(completions, 4)).times(DC.E500000),
  ...
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E1000.pow(Math.min(completions, 4)).times(DC.E3000),
      formatValue: value => format(value)
    }
  },
  {
    ...
    secondary: {
      ...
      required: completions => DC.E2000.pow(Math.min(completions, 4)).times(DC.E15000),
      formatValue: value => format(value)
    }
  },
  {
